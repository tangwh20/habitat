INTRO_HISTORY = (
    ...
    "3. **Last Navigation Step**: The most recent action taken by the robot, which may include a low-level command (e.g., `turn_right(30)`).\n"
...
REMINDER_HISTORY = (
    "IMPORTANT:\n"
    "1. **Be Concise**: The history should be detailed but not overly verbose. Focus on key locations and objects.\n"
